# this contains code which, upon scraping a page,
# 1. downloads PDFs of documents and moves them to S3
# 2. extracts text and vectorized versions of documents and saves to S3
# 3. updates the entry in the autolocal-tables dynamodb entry accordingly
